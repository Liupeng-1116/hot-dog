...
from dataset import dataloaders, batch_size, cat_to_name

# 处理照片数据函数，检测照片预处理函数，展示一张照片函数
from function import im_convert, process_image, imshow
...
writer = tensorboard.SummaryWriter("./hot_dog_forecast")
